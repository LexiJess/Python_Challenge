...
with open(PyPoll, newline='') as csvfile:
    ...
    print ("Khan:", percentage_Khan, Khan_votes)
    print ("Correy:", percentage_Correy, Correy_votes)
    print ("Li:", percentage_Li, Li_votes)
    print ("Otooley:", percentage_Otooley, Otooley_votes)
    print ("--------------------------")
